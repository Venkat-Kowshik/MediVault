       ...
       {/* <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
        ...
        <div className="flex flex-row justify-between items-center w-full">
          ...
          Hello, Health Geeks!! <br className="sm:block hidden" />{" "}
            <span className="text-gradient">Welcome To MediVault!!  </span>{" "}
          </h1>
        ...
        MediVault: Your personal health fortress, safeguarding your medical records with ironclad security and effortless access.
        </p>
      </div>
